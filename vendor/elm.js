...
Elm.Compass.make = function (_elm) {
   ...
   var toModel = function (_v0) {
      return function () {
         ...
         {case "_Tuple3": return {_: {}
                                 ...
                                 ,units: _v0._2};}
         _U.badCase($moduleName,
         "on line 37, column 21 to 45");
      }();
   };
   var simplify = function (_v5) {
      return function () {
         switch (_v5.ctor)
         {case "_Tuple2":
            return function () {
                 var mile = function (m) {
                    return $Basics.floor(m * 0.62137 / 1000);
                 };
                 var foot = function (m) {
                    return $Basics.floor(m * 3.281);
                 };
                 var inch = function (m) {
                    return foot(m) * 12;
                 };
   ...
   var convert = function (rg) {
      return function () {
         ...
         var arg1 = $Basics.sin(dLon) * $Basics.cos(brainLat);
         var arg2 = $Basics.cos(lat) * $Basics.sin(brainLat) - $Basics.sin(lat) * $Basics.cos(brainLat) * $Basics.cos(dLon);
